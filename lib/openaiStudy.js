...
Return valid JSON with EXACTLY these keys:
{
  ...
  "highlightStat": { "label": "...", "from": "...", "to": "...", "magnitude": "..." } or null,
...
Rules:
- NEVER use LaTeX notation (no \frac, \sqrt, \cdot, \times, $...$ etc.). Write math in plain Unicode: use ², ³, ×, ÷, √, π, ≠, ≤, ≥, ∑, fractions as e.g. "2/3", exponents as e.g. "x²".
...
- summary should explain the main idea naturally, not as a forced slogan or fake statistic
...
- highlightStat is optional and should be null unless there is one genuinely meaningful numeric, comparative, or measurable takeaway
- never invent a fake from/to transformation just to fill highlightStat
- if the best candidate would look trivial, repetitive, or confusing such as "6 -> 6", return null for highlightStat
